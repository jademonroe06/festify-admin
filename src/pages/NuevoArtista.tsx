...
export default function NewArtist() {
    ...
    const value = parseInt(e.target.value, 10); // Convertir el valor del input a número
    //
    }; //mirar como hacer que funcione el onChange de oyentes
    ...
    }; //mirar como hacer que solo mande la petición cuando se haga click
       //fuera del apartado de biografía
    ...
    const handleCreateArtist = (newForm) => {
        setForm();
    };
